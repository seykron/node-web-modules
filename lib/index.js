...
require("./ModuleRequestWrapper.js");
require("./Module.js");
...
/** Enumeration of supported middlewares for modules. Any of these types
 * can be specified when a Module is instantiated.
 * @namespace
 */
WebModules.Middleware = {
...
var init = function (server) {
  ...
  for (type in WebModules.Middleware) {
    if (WebModules.Middleware.hasOwnProperty(type)) {
      WebModules.Middleware[type].init(server);
    }
  }
};
